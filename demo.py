...
if __name__ == "__main__":
    ...
    args.frames_path = os.path.join(os.path.abspath('../databases/DAVIS2017/train/JPEGImages/480p'),Video)
    args.init_mask_path = os.path.join(os.path.abspath('../databases/DAVIS2017/train/Annotations/480p'),Video,'00000.png')
